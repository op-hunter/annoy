...
class AnnoyIndexInterface {
 public:
  ...
  virtual void get_nns_by_item(S item, size_t n, size_t search_k, vector<S>* result, vector<T>* distances,
                               faiss::ConcurrentBitsetPtr bitset = nullptr) const = 0;
  virtual void get_nns_by_vector(const T* w, size_t n, size_t search_k, vector<S>* result, vector<T>* distances,
                                 faiss::ConcurrentBitsetPtr bitset = nullptr) const = 0;
